...
public class calculos {
   ...
   public static class Calculos {
        ...
        ConsultaDeConversion.ConsultaConversion conversion;


        public Calculos(ConsultaDeConversion.ConsultaConversion conversion) {
        ...
        public String obtenerMensajeRespuesta() {
            ...
            mensajeBuilder
                    .append(conversion.buscaConversion(getMonedaBase(), getMonedaObjetivo(), getCantidad()));
